...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const entries: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
    ...
    { path: "/services/asbestos-testing", priority: 0.8, changeFrequency: "monthly" },
    { path: "/services/asbestos-removal", priority: 0.9, changeFrequency: "monthly" },
    { path: "/services/asbestos-garage-roof-removal", priority: 0.9, changeFrequency: "monthly" },
